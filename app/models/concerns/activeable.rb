module Activeable
  ...
  def deleted_it
    self.active = DELETED
    OperationLog.create_by_entity(self, 'deleted', current_employee)
    self.save
  end
  ...
  def inactive_it
    ...
    OperationLog.create_by_entity(self, 'inactive', current_employee)
    self.save
  end
  ...
  def active_it
    ...
    self.active = ACTIVE
    OperationLog.create_by_entity(self, 'active', current_employee)
    self.save
  end
